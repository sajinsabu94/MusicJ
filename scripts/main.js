 ...
 function() {
  ...
  function e(e, a, t, i, s, l, o) {
   var n = [i.loadAmCharts(), e(3e3)],
    r = o;
   r.blur && (r.mobile ? n.unshift(i.loadImg(t.images.root + "MusicJ.jpg")) : (n.unshift(i.loadImg(t.images.root + "MusicJ.jpg")), n.unshift(i.loadImg(t.images.root + "MusicJ.jpg")))), s.all(n).then(function() {
   ...
   return {
    link: function(e, a) {
     a.bind("change", function(a) {
      e.file = (a.srcElement || a.target).files[0],
       e.getFile()
     })
    }
   }
